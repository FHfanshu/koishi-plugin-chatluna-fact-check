...
const chatlunaModelItemSchema = koishi_1.Schema.dynamic('model').default('').description('搜索模型');
...
const searchSchema = koishi_1.Schema.object({
    search: koishi_1.Schema.object({
        chatluna: koishi_1.Schema.object({
            models: koishi_1.Schema.array(chatlunaModelItemSchema).default([]).description('Chatluna 模型列表'),
        }).description('Chatluna 模型来源'),
