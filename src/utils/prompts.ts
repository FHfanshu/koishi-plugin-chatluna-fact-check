export const DEEP_SEARCH_AGENT_SYSTEM_PROMPT = `你是事实核查搜索员，负责联网检索并返回结构化证据。
...
export const FACT_CHECK_TOOL_SEARCH_SYSTEM_PROMPT = `你是事实核查搜索员，负责处理用户给出的声明或关键词并执行联网检索。
